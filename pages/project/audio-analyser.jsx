...
function Bust() {
  const ref = useRef();
  const time = useRef(0);
  const { scene, animations, materials } = useGLTF("/audioAnalyser/bust.glb");
...
function Ground() {
  const [floor, normal] = useTexture([
    "/audioAnalyser/SurfaceImperfections003_1K_var1.jpg",
    "/audioAnalyser/SurfaceImperfections003_1K_Normal.jpg",
  ]);
  return (
    <Reflector
      position={[0, -0.225, 0]}
